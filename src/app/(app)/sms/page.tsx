          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <Card><CardContent className="space-y-4 p-6">
              ...
              <form action={saveSmsSettingsAction} className="space-y-3">
                ...
                <Field
                  label="Sender ID"
                  hint={`Max ${smsCountryRule(settings.countryCode).maxSenderIdLen} chars � brand name or short code`}
                >
                  <Input
                    name="senderId"
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Field label="Quiet start" hint="Local time � no promotional sends">
                    <Input
                ...
                <Field
                  ...
                  hint="Optional spend ceiling � blank = uncapped"
                >
                  <Input
            ...
            <Card><CardContent className="space-y-4 p-6">
              ...
              <form action={addSmsSubscriberAction} className="space-y-3">
                <input type="hidden" name="companyId" value={company.id} />
                <Field label="Phone" hint="E.164 preferred � e.g. +61400111222">
                  <Input name="phone" required placeholder="+61400111222" />
                </Field>
                <Field label="Name" hint="Optional � used in {{name}} merge">
