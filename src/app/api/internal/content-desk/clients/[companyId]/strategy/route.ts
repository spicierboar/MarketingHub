...
import { updateClientStrategy } from "@/lib/content-desk/service";
import { StrategyMutationSchema } from "@/lib/content-desk/types";
...
export async function PATCH(request: NextRequest, context: Context) {
  ...
  const parsed = await strictJson(request, StrategyMutationSchema);
